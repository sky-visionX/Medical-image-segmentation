...
if __name__ == '__main__':
    """
    CUDA_VISIBLE_DEVICES=0 python Vimeo90K.py --model_dir ../experiments/rife/train_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/
    """

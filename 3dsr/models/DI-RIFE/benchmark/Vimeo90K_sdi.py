...
if __name__ == '__main__':
    """
    cmd:
    CUDA_VISIBLE_DEVICES=4 python Vimeo90K_sdi.py --model_dir ../experiments/rife_sdi_m_noavg_blur_triplet/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --blur --clip
    """

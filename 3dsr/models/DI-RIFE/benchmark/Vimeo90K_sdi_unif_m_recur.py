...
if __name__ == '__main__':
    """
    cmd:
    CUDA_VISIBLE_DEVICES=4 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_sdi_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 1
    CUDA_VISIBLE_DEVICES=5 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_sdi_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 2
    CUDA_VISIBLE_DEVICES=6 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_sdi_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 3
    **************************************************************
    CUDA_VISIBLE_DEVICES=1 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 1
    CUDA_VISIBLE_DEVICES=2 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 2
    CUDA_VISIBLE_DEVICES=3 screen python Vimeo90K_sdi_unif_m_recur.py --model_dir ../experiments/rife_m_recur_noorder_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --iters 3
    """

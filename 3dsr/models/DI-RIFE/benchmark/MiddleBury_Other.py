...
IE_list = []
for i in name:
    i0 = cv2.imread('other-Meningioma_converted_preprocessedraw/{}/frame10.png'.format(i)).transpose(2, 0, 1) / 255.
    i1 = cv2.imread('other-Meningioma_converted_preprocessedraw/{}/frame11.png'.format(i)).transpose(2, 0, 1) / 255.

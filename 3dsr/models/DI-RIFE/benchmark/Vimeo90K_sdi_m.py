...
if __name__ == '__main__':
    """
    cmd:
    CUDA_VISIBLE_DEVICES=0 python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m/train_sdi_log --testset_path ../../Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}_avg.npy --clip
    CUDA_VISIBLE_DEVICES=5 python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m/train_sdi_log --testset_path ../../Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}_avg.npy --clip --mid_only
    
    CUDA_VISIBLE_DEVICES=0 python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m_noavg/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --clip
    CUDA_VISIBLE_DEVICES=1 python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_wodistill_sdi_m_recur_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --clip
    
    *********************************************************
    CUDA_VISIBLE_DEVICES=0 screen python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m_noavg/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --clip
    CUDA_VISIBLE_DEVICES=1 screen python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m_noavg_blur_e1200/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --clip
    
    CUDA_VISIBLE_DEVICES=4 screen python Vimeo90K_sdi_m.py --model_dir ../experiments/rife_sdi_m_noavg_blur/train_sdi_log --testset_path /mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet/ --sdi_name dis_index_{}_{}_{}.npy --clip --blur
    """
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_dir', type=str, default='train_sdi_log')
    parser.add_argument('--testset_path', type=str, default='../Meningioma_converted_preprocessedraw/vimeo_triplet/')

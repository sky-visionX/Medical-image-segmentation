...
class VimeoDataset(Dataset):
    def __init__(self, dataset_name, batch_size=32, sdi_name='dis_index_{}_{}_{}.npy',
        ...
        self.h = 256
        self.w = 448
        # self.data_root = '../Meningioma_converted_preprocessedraw/vimeo_triplet'
        # self.data_root = '/mnt/disks/ssd0/Meningioma_converted_preprocessedraw/vimeo_triplet'
        self.data_root = '/home/dell/wzh/new/InterpAny-Clearer-main/Meningioma_converted_preprocessedraw/vimeo_triplet'

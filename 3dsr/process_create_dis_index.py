...
sys.path.append('/home/dell/wzh/new/InterpAny-Clearer-main/RAFT')
sys.path.append('/home/dell/wzh/new/InterpAny-Clearer-main/RAFT/core')
sys.path.append('/InterpAny-Clearer-main/Meningioma_converted_preprocessedraw')

try:
    from dataset2.dis_index import FlowEstimator, cosine_project_ratio
except ImportError:
...
def create_dis_index_for_dataset(sample_paths, avg=False, downsample_ratio=2., sample_length=7):
    for sample_path in tqdm(sample_paths, total=len(sample_paths)):
        ...
        if sample_path.startswith('sequences/'):
            sample_path = sample_path[10:]  # len('sequences/') == 10

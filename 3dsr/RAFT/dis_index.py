...
class FlowEstimator:
    ...
    def __init__(self, checkpoint, iters=32, device='cuda'):
        self.iters = iters
        self.device = device
    ...
    def batch_estimate_flow(self, img1, img2):
        ...
        flow_low, flow_up = self.model(img1, img2, iters=16, test_mode=True)
        return flow_up
    ...
    def estimate_flow(self, img1_path, img2_path, visualize=True):
        ...
        flow_low, flow_up = self.model(img1, img2, iters=64, test_mode=True)
...
if __name__ == '__main__':
    ...
    python dis_index.py
    '''
    checkpoint = '/home/dell/wzh/new/InterpAny-Clearer-main/checkpoints/raft-things.pth'
    flow_estimator = FlowEstimator(checkpoint=checkpoint)
    img1_path = '/home/dell/wzh/InterpAny-Clearer-main/visual/img/brain/1-5/000.png'
    img2_path = '/home/dell/wzh/InterpAny-Clearer-main/visual/img/brain/1-5/im3.png'
    img3_path = '/home/dell/wzh/InterpAny-Clearer-main/visual/img/brain/1-5/002.png'

...
```py
const IMAGE_PATH = "/assets/Meningioma_converted_preprocessedraw/dogs.jpg";
const IMAGE_EMBEDDING = "/assets/Meningioma_converted_preprocessedraw/dogs_embedding.npy";

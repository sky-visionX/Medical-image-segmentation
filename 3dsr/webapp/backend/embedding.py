...
class Embedding():
    def __init__(self, outDir='./Meningioma_converted_preprocessedraw/results', modelDir='./Meningioma_converted_preprocessedraw/models'):
    ...
    def generateEmbedding(self, filename):
        ...
        embeddingFileUrl = f'Meningioma_converted_preprocessedraw/embeddings/{embeddingFile}.npy'
